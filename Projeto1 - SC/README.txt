...
java -cp bin -Djava.security.manager -Djava.security.policy==src/server.policy Server.SeiTchizServer 45678

Executar ficheiro .jar:
java -cp bin -Djava.security.manager -Djava.security.policy==src/server.policy -jar SeiTchizServer.jar 45678


- Exemplo de comando para execucao do cliente:
Executar ficheiros .class:
java -cp bin -Djava.security.manager -Djava.security.policy==src/client.policy Client.SeiTchiz 127.0.0.1:45678 userName password123

Executar ficheiro .jar:
java -cp bin -Djava.security.manager -Djava.security.policy==src/client.policy -jar SeiTchiz.jar 127.0.0.1:45678 userName password123
