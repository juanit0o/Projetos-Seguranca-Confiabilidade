...
public class Cliente {
	...
	public boolean seguir(Cliente clientASeguir){
		...
		//verificar se o cliente ja segue essa pessoa (parte da pessoa exisitr ou nao feito no sv - existeId)
	...
	public void userContentsToFile () {
		...
		File fileUser = new File("..\\data\\Personal User Files\\" +this.ID + "\\info.txt"); //POR NO SITIO DOS FOLLOWERS
		try {
